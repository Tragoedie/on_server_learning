...
class Test_BST(unittest.TestCase):
    ...
    def test_add_and_find(self):
        tree = BST(None)
        self.assertEqual(tree.AddKeyValue(10, 10), True)
        ...
        self.assertTrue(tree.AddKeyValue(11, 11))
    ...
    def test_FinMinMax(self):
        ...
        self.assertTrue(tree.AddKeyValue(Child_9[0], Child_9[1]))
        self.assertTrue(tree.AddKeyValue(Child_10[0], Child_10[1]))
        self.assertTrue(tree.AddKeyValue(Child_11[0], Child_11[1]))
        self.assertTrue(tree.AddKeyValue(Child_12[0], Child_12[1]))
        self.assertTrue(tree.AddKeyValue(Child_13[0], Child_13[1]))
    ...
    def test_FinMinMax_2(self):
        tree = BST(None)
        Child_1 = (10, 10)
        self.assertTrue(tree.AddKeyValue(Child_1[0], Child_1[1]))
        self.assertEqual(tree.FinMinMax(tree.Root, False).NodeValue, 10)
        self.assertEqual(tree.FinMinMax(tree.Root, True).NodeValue, 10)
        self.assertEqual(tree.Count(), 1)
    ...
    def test_del_root_with_RightChild(self):
        ...
        self.assertTrue(tree.AddKeyValue(Child_13[0], Child_13[1]))
        self.assertTrue(tree.AddKeyValue(Child_14[0], Child_14[1]))
        self.assertTrue(tree.AddKeyValue(Child_15[0], Child_15[1]))
