...
т.к. последний узел хранится в переменной tail его легко отметить курсором.


2. Операция поиска всех узлов с заданным значением, выдающая список таких узлов, уже не нужна. Почему?
Имеется операция find и константа STATUS_NODE_FIND, ее можно вызывать в цикле и получить список узлов.
"""
