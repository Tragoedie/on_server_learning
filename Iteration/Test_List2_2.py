import unittest
from on_server_learning.Iteration.List2_2 import List2_2


class List2_2_tests(unittest.TestCase):

    def test_List2_2_1(self):
        massive = []
        self.l2_2 = List2_2(5, False)
        for i in self.l2_2:
            massive.append(i)
        self.assertEqual(massive, [1, 2, 4, 8, 16])

    def test_List2_2_2(self):
        massive = []
        self.l2_1 = List2_2(100, False)
        for i in self.l2_1:
            massive.append(i)
        self.assertEqual(massive, [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536,
                                   ...
                                   2361183241434822606848, 4722366482869645213696, 9444732965739290427392,
                                   18889465931478580854784, 37778931862957161709568, 75557863725914323419136,
                                   151115727451828646838272, 302231454903657293676544, 604462909807314587353088,
                                   1208925819614629174706176, 2417851639229258349412352, 4835703278458516698824704,
                                   9671406556917033397649408, 19342813113834066795298816, 38685626227668133590597632,
                                   77371252455336267181195264, 154742504910672534362390528, 309485009821345068724781056,
                                   618970019642690137449562112, 1237940039285380274899124224,
                                   2475880078570760549798248448, 4951760157141521099596496896,
                                   9903520314283042199192993792, 19807040628566084398385987584,
                                   39614081257132168796771975168, 79228162514264337593543950336,
